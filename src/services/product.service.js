...
export const createproduct = async ({
    ...
    const query =
        'Insert into product(category_id,title,picture,summary,description,price,discount_type,discount_value,tags) Values($1,$2,$3,$4,$5,$6,$7,$8,$9)'
    const arr = [
        category_id,
        title,
        picture,
...
export const updateproduct = async ({
    ...
    const query = 'Select * from product where id=$1'
    const updatequery =
        'Update product set category_id=$1,title=$2,picture=$3,summary=$4,description=$5,price=$6,discount_type=$7,discount_value=$8,tags=$9 where id=$10'
    const arr = [
        category_id,
        title,
        picture,
